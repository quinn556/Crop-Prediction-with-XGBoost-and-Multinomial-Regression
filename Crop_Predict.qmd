...
The data is imbalanced here so that may be tricky when building the models later.
# Visualizations
...
Things to note:
- phosphorous and potassium are correlated
- If "group" is the outcome variable, there is some imbalance
- If "crop" is the outcome variable, there are many levels, but they are pretty balanced
